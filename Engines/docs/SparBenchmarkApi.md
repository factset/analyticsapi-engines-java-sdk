...
import factset.analyticsapi.engines.api.SparBenchmarkApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        SparBenchmarkApi apiInstance = new SparBenchmarkApi(defaultClient);
        String id = "id_example"; // String | Benchmark Identifier
        try {
            SPARBenchmark result = apiInstance.getSPARBenchmarkById(id);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling SparBenchmarkApi#getSPARBenchmarkById");
