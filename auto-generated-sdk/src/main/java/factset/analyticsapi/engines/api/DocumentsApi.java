...
public class DocumentsApi {
   ...
   */
  public DocumentDirectories getPubDocuments(String path) throws ApiException {
   ...
   */
  public ApiResponse<DocumentDirectories> getPubDocumentsWithHttpInfo(String path) throws ApiException {
    Object localVarPostBody = null;
    ...
    // create path and map variables
    String localVarPath = "/analytics/lookups/v2/engines/pub/documents/{path}"
      .replaceAll("\\{" + "path" + "\\}", apiClient.escapeString(path.toString()));
