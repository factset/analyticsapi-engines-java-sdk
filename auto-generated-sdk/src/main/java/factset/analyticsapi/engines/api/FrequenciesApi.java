...
import factset.analyticsapi.engines.models.StringFrequencyDictionaryObjectDataAndMetaModel;
...
public class FrequenciesApi {
   ...
   * This endpoint lists all the frequencies that can be applied to a PA calculation.
    @return StringFrequencyDictionaryObjectDataAndMetaModel
   ...
   */
 public StringFrequencyDictionaryObjectDataAndMetaModel getPAFrequencies() throws ApiException {
   ...
   * Get PA frequencies
   * This endpoint lists all the frequencies that can be applied to a PA calculation.
    * @return ApiResponse&lt;StringFrequencyDictionaryObjectDataAndMetaModel&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<StringFrequencyDictionaryObjectDataAndMetaModel> getPAFrequenciesWithHttpInfo() throws ApiException {
    ...
    GenericType<StringFrequencyDictionaryObjectDataAndMetaModel> localVarReturnType = new GenericType<StringFrequencyDictionaryObjectDataAndMetaModel>() {};

      Map<Integer, GenericType> returnTypeMap = new HashMap<Integer, GenericType>();
        returnTypeMap.put(200, new GenericType<StringFrequencyDictionaryObjectDataAndMetaModel>(){});
	
      return apiClient.<StringFrequencyDictionaryObjectDataAndMetaModel>invokeAPIWithReturnMap("FrequenciesApi.getPAFrequencies", localVarPath, "GET", localVarQueryParams, localVarPostBody,
   ...
   */
 public StringFrequencyDictionaryObjectDataAndMetaModel getSPARFrequencies() throws ApiException {
   ...
   */
  public ApiResponse<StringFrequencyDictionaryObjectDataAndMetaModel> getSPARFrequenciesWithHttpInfo() throws ApiException {
    Object localVarPostBody = null;
    ...
    GenericType<StringFrequencyDictionaryObjectDataAndMetaModel> localVarReturnType = new GenericType<StringFrequencyDictionaryObjectDataAndMetaModel>() {};
      ...
      return apiClient.<StringFrequencyDictionaryObjectDataAndMetaModel>invokeAPIWithReturnMap("FrequenciesApi.getSPARFrequencies", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, returnTypeMap, false);
  }
  /**
   ...
   */
 public StringFrequencyDictionaryObjectDataAndMetaModel getVaultFrequencies() throws ApiException {
   ...
   */
  public ApiResponse<StringFrequencyDictionaryObjectDataAndMetaModel> getVaultFrequenciesWithHttpInfo() throws ApiException {
    Object localVarPostBody = null;
    ...
    GenericType<StringFrequencyDictionaryObjectDataAndMetaModel> localVarReturnType = new GenericType<StringFrequencyDictionaryObjectDataAndMetaModel>() {};
      ...
      return apiClient.<StringFrequencyDictionaryObjectDataAndMetaModel>invokeAPIWithReturnMap("FrequenciesApi.getVaultFrequencies", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, returnTypeMap, false);
  }
}
