...
public class PricingSourcesApi {
 ...
 public PAPricingSourceRoot getPAPricingSources(String name, String category, String directory) throws ApiException {
  ...
  public ApiResponse<PAPricingSourceRoot> getPAPricingSourcesWithHttpInfo(String name, String category, String directory) throws ApiException {
    ...
    GenericType<PAPricingSourceRoot> localVarReturnType = new GenericType<PAPricingSourceRoot>() {};

      Map<Integer, GenericType> returnTypeMap = new HashMap<Integer, GenericType>();
        returnTypeMap.put(200, new GenericType<PAPricingSourceRoot>(){});
        returnTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
        returnTypeMap.put(404, new GenericType<ClientErrorResponse>(){});
	
      return apiClient.<PAPricingSourceRoot>invokeAPIWithReturnMap("PricingSourcesApi.getPAPricingSources", localVarPath, "GET", localVarQueryParams, localVarPostBody,
