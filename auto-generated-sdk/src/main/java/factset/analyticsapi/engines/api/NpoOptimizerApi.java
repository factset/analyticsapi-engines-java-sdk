...
import factset.analyticsapi.engines.models.NPOOptimizationParametersRoot;
...
public class NpoOptimizerApi {
 ...
 public void cancelOptimizationById(String id) throws ApiException {
   ...
   * @param id from url, provided from the location header in the Create and Run NPO optimization endpoint (required)
    @return NPOOptimizationParametersRoot
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
 public NPOOptimizationParametersRoot getOptimizationParameters(String id) throws ApiException {
   ...
   * This is the endpoint that returns the optimization parameters passed for an optimization.
   * @param id from url, provided from the location header in the Create and Run NPO optimization endpoint (required)
    * @return ApiResponse&lt;NPOOptimizationParametersRoot&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<NPOOptimizationParametersRoot> getOptimizationParametersWithHttpInfo(String id) throws ApiException {
    Object localVarPostBody = null;
    ...
    GenericType<NPOOptimizationParametersRoot> localVarReturnType = new GenericType<NPOOptimizationParametersRoot>() {};

      Map<Integer, GenericType> returnTypeMap = new HashMap<Integer, GenericType>();
        returnTypeMap.put(200, new GenericType<NPOOptimizationParametersRoot>(){});
        returnTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
        returnTypeMap.put(404, new GenericType<ClientErrorResponse>(){});
	
      return apiClient.<NPOOptimizationParametersRoot>invokeAPIWithReturnMap("NpoOptimizerApi.getOptimizationParameters", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, returnTypeMap, false);
  }
  /**
 ...
 public ObjectRoot getOptimizationResult(String id) throws ApiException {
  ...
  public ApiResponse<ObjectRoot> getOptimizationResultWithHttpInfo(String id) throws ApiException {
    ...
    GenericType<ObjectRoot> localVarReturnType = new GenericType<ObjectRoot>() {};
      ...
      return apiClient.<ObjectRoot>invokeAPIWithReturnMap("NpoOptimizerApi.getOptimizationResult", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, returnTypeMap, false);
  }
  /**
 ...
 public Object getOptimizationStatusById(String id) throws ApiException {
  ...
  public ApiResponse<Object> getOptimizationStatusByIdWithHttpInfo(String id) throws ApiException {
    ...
    GenericType<ObjectRoot> localVarReturnType = new GenericType<ObjectRoot>() {};
      ...
      return apiClient.<Object>invokeAPIWithReturnMap("NpoOptimizerApi.getOptimizationStatusById", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, returnTypeMap, false);
  }
  /**
   ...
   * @param npOOptimizationParametersRoot Optimization Parameters (optional)
   ...
   */
 public Object postAndOptimize(Integer xFactSetApiLongRunningDeadline, String cacheControl, NPOOptimizationParametersRoot npOOptimizationParametersRoot) throws ApiException {
    return postAndOptimizeWithHttpInfo(xFactSetApiLongRunningDeadline, cacheControl, npOOptimizationParametersRoot).getData();
  }
   ...
   */
  public ApiResponse<Object> postAndOptimizeWithHttpInfo(Integer xFactSetApiLongRunningDeadline, String cacheControl, NPOOptimizationParametersRoot npOOptimizationParametersRoot) throws ApiException {
    Object localVarPostBody = npOOptimizationParametersRoot;
...
if (cacheControl != null)
    ...
    GenericType<ObjectRoot> localVarReturnType = new GenericType<ObjectRoot>() {};
      ...
      return apiClient.<Object>invokeAPIWithReturnMap("NpoOptimizerApi.postAndOptimize", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, returnTypeMap, false);
  }
  /**
   ...
   */
 public Object putAndOptimize(String id, Integer xFactSetApiLongRunningDeadline, String cacheControl, NPOOptimizationParametersRoot npOOptimizationParametersRoot) throws ApiException {
    return putAndOptimizeWithHttpInfo(id, xFactSetApiLongRunningDeadline, cacheControl, npOOptimizationParametersRoot).getData();
  }
   ...
   */
  public ApiResponse<Object> putAndOptimizeWithHttpInfo(String id, Integer xFactSetApiLongRunningDeadline, String cacheControl, NPOOptimizationParametersRoot npOOptimizationParametersRoot) throws ApiException {
    Object localVarPostBody = npOOptimizationParametersRoot;
...
if (cacheControl != null)
    ...
    GenericType<ObjectRoot> localVarReturnType = new GenericType<ObjectRoot>() {};
      ...
      return apiClient.<Object>invokeAPIWithReturnMap("NpoOptimizerApi.putAndOptimize", localVarPath, "PUT", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, returnTypeMap, false);
  }
}
