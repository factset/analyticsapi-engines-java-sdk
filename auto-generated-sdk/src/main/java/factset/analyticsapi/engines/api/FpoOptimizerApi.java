...
public class FpoOptimizerApi {
  ...
  * @return ApiResponse&lt;Void&gt;
  ...
  public ApiResponse<Void> cancelOptimizationByIdWithHttpInfo(String id) throws ApiException {
    ...
    return apiClient.<Void>invokeAPIWithReturnMap("FpoOptimizerApi.cancelOptimizationById", localVarPath, "DELETE", localVarQueryParams, localVarPostBody,
   ...
   * @param id from url, provided from the location header in the Create and Run FPO optimization endpoint (required)
   * @return (200 - FPOOptimizationParametersRoot)(400 - ClientErrorResponse)(404 - ClientErrorResponse)
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   * This is the endpoint that returns the optimization parameters passed for a calculation.
   * @param id from url, provided from the location header in the Create and Run FPO optimization endpoint (required)
  * @return (200 - ApiResponse&lt;FPOOptimizationParametersRoot&gt;)(400 - ApiResponse&lt;ClientErrorResponse&gt;)(404 - ApiResponse&lt;ClientErrorResponse&gt;)
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
  ...
  public ApiResponse<Object> getOptimizationParametersWithHttpInfo(String id) throws ApiException {
    ...
    return apiClient.<Object>invokeAPIWithReturnMap("FpoOptimizerApi.getOptimizationParameters", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, returnTypeMap, false);
  }
  /**
  ...
  * @return (200 - ApiResponse&lt;ObjectRoot&gt;)(400 - ApiResponse&lt;ClientErrorResponse&gt;)(404 - ApiResponse&lt;ClientErrorResponse&gt;)
  ...
  public ApiResponse<Object> getOptimizationResultWithHttpInfo(String id, String accept) throws ApiException {
    ...
    return apiClient.<Object>invokeAPIWithReturnMap("FpoOptimizerApi.getOptimizationResult", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, returnTypeMap, false);
  }
  /**
