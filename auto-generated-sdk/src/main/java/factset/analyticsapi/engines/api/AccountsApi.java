...
public class AccountsApi {
   ...
   * @return (200 - AccountDirectoriesRoot)
   ...
   */
  public Object getAccounts(String path) throws ApiException {
   ...
   * This endpoint looks up all ACCT and ACTM files and sub-directories in a given directory.
   * @param path The directory to get the accounts and sub-directories in (required)
  * @return (200 - ApiResponse&lt;AccountDirectoriesRoot&gt;)
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<Object> getAccountsWithHttpInfo(String path) throws ApiException {
    ...
    GenericType<AccountDirectoriesRoot> localVarReturnType = new GenericType<AccountDirectoriesRoot>() {};
	 ...
	 returnTypeMap.put(200, new GenericType<AccountDirectoriesRoot>(){});
	
    return apiClient.<Object>invokeAPIWithReturnMap("AccountsApi.getAccounts", localVarPath, "GET", localVarQueryParams, localVarPostBody,
