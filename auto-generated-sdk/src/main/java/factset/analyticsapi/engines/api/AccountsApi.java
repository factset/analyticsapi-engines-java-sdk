...
import factset.analyticsapi.engines.models.SPARAccountsObjectDataAndMetaModel;
...
public class AccountsApi {
   ...
   * @param accountPath URL encoded account path (required)
    @return SPARAccountsObjectDataAndMetaModel
   ...
   */
 public SPARAccountsObjectDataAndMetaModel getSPARReturnsType(String accountPath) throws ApiException {
   ...
   * This endpoint returns the returns type of account associated with SPAR
   * @param accountPath URL encoded account path (required)
    * @return ApiResponse&lt;SPARAccountsObjectDataAndMetaModel&gt;
   * @throws ApiException if fails to make API call
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
   ...
   */
  public ApiResponse<SPARAccountsObjectDataAndMetaModel> getSPARReturnsTypeWithHttpInfo(String accountPath) throws ApiException {
    ...
    GenericType<SPARAccountsObjectDataAndMetaModel> localVarReturnType = new GenericType<SPARAccountsObjectDataAndMetaModel>() {};

      Map<Integer, GenericType> returnTypeMap = new HashMap<Integer, GenericType>();
        returnTypeMap.put(200, new GenericType<SPARAccountsObjectDataAndMetaModel>(){});
        returnTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
        returnTypeMap.put(404, new GenericType<ClientErrorResponse>(){});
	
      return apiClient.<SPARAccountsObjectDataAndMetaModel>invokeAPIWithReturnMap("AccountsApi.getSPARReturnsType", localVarPath, "GET", localVarQueryParams, localVarPostBody,
