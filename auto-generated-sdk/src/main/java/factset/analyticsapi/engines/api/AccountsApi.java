 ...
 public AccountDirectoriesRoot getAccounts(String path) throws ApiException {
  ...
  public ApiResponse<AccountDirectoriesRoot> getAccountsWithHttpInfo(String path) throws ApiException {
    ...
    GenericType<AccountDirectoriesRoot> localVarReturnType = new GenericType<AccountDirectoriesRoot>() {};
      ...
      return apiClient.<AccountDirectoriesRoot>invokeAPIWithReturnMap("AccountsApi.getAccounts", localVarPath, "GET", localVarQueryParams, localVarPostBody,
 ...
 public SPARAccountsRoot getSPARReturnsType(String accountPath) throws ApiException {
  ...
  public ApiResponse<SPARAccountsRoot> getSPARReturnsTypeWithHttpInfo(String accountPath) throws ApiException {
    ...
    GenericType<SPARAccountsRoot> localVarReturnType = new GenericType<SPARAccountsRoot>() {};
      ...
      Map<Integer, GenericType> returnTypeMap = new HashMap<Integer, GenericType>();
        returnTypeMap.put(200, new GenericType<SPARAccountsRoot>(){});
        returnTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
        returnTypeMap.put(404, new GenericType<ClientErrorResponse>(){});
	
      return apiClient.<SPARAccountsRoot>invokeAPIWithReturnMap("AccountsApi.getSPARReturnsType", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, returnTypeMap, false);
  }
}
