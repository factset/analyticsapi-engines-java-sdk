...
public class SparCalculationsApi {
 ...
 public void cancelCalculationById(String id) throws ApiException {
   ...
   * @http.response.details
     <table summary="Response Details" border="1">
       <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
       <tr><td> 200 </td><td> List of active calculation requests. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
       ...
       <tr><td> 404 </td><td> No active calculation. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
       <tr><td> 401 </td><td> Missing or invalid authentication. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  </td></tr>
       <tr><td> 403 </td><td> User is forbidden with current credentials. </td><td>  * X-DataDirect-Request-Key - FactSet&#39;s request key header. <br>  * X-FactSet-Api-Request-Key - Key to uniquely identify an Analytics API request. Only available after successful authentication. <br>  * X-FactSet-Api-RateLimit-Limit - Number of allowed requests for the time window. <br>  * X-FactSet-Api-RateLimit-Remaining - Number of requests left for the time window. <br>  * X-FactSet-Api-RateLimit-Reset - Number of seconds remaining till rate limit resets. <br>  </td></tr>
 ...
 public CalculationsSummaryRoot getAllCalculations(Integer pageNumber) throws ApiException {
  ...
  public ApiResponse<CalculationsSummaryRoot> getAllCalculationsWithHttpInfo(Integer pageNumber) throws ApiException {
    ...
    GenericType<CalculationsSummaryRoot> localVarReturnType = new GenericType<CalculationsSummaryRoot>() {};
      ...
      return apiClient.<CalculationsSummaryRoot>invokeAPIWithReturnMap("SparCalculationsApi.getAllCalculations", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, returnTypeMap, false);
  }
  /**
 ...
 public SPARCalculationParametersRoot getCalculationParameters(String id) throws ApiException {
  ...
  public ApiResponse<SPARCalculationParametersRoot> getCalculationParametersWithHttpInfo(String id) throws ApiException {
    ...
    GenericType<SPARCalculationParametersRoot> localVarReturnType = new GenericType<SPARCalculationParametersRoot>() {};
      ...
      Map<Integer, GenericType> returnTypeMap = new HashMap<Integer, GenericType>();
        returnTypeMap.put(200, new GenericType<SPARCalculationParametersRoot>(){});
        returnTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
        returnTypeMap.put(404, new GenericType<ClientErrorResponse>(){});
 ...
 public ObjectRoot getCalculationUnitResultById(String id, String unitId) throws ApiException {
   ...
   */
 public Object postAndCalculate(Integer xFactSetApiLongRunningDeadline, String cacheControl, SPARCalculationParametersRoot spARCalculationParametersRoot) throws ApiException {
   ...
   */
  public ApiResponse<Object> postAndCalculateWithHttpInfo(Integer xFactSetApiLongRunningDeadline, String cacheControl, SPARCalculationParametersRoot spARCalculationParametersRoot) throws ApiException {
...
if (cacheControl != null)
    ...
    GenericType<CalculationStatusRoot> localVarReturnType = new GenericType<CalculationStatusRoot>() {};
      ...
      return apiClient.<Object>invokeAPIWithReturnMap("SparCalculationsApi.postAndCalculate", localVarPath, "POST", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, returnTypeMap, false);
  }
  /**
   ...
   */
 public Object putAndCalculate(String id, Integer xFactSetApiLongRunningDeadline, String cacheControl, SPARCalculationParametersRoot spARCalculationParametersRoot) throws ApiException {
   ...
   */
  public ApiResponse<Object> putAndCalculateWithHttpInfo(String id, Integer xFactSetApiLongRunningDeadline, String cacheControl, SPARCalculationParametersRoot spARCalculationParametersRoot) throws ApiException {
    Object localVarPostBody = spARCalculationParametersRoot;
