...
import factset.analyticsapi.engines.models.PACommentaryConfigurationSummaryRoot;
...
public class ConfigurationsApi {
 ...
 public PACommentaryConfigurationSummaryRoot getPACommentaryConfigurations(String path) throws ApiException {
  ...
  public ApiResponse<PACommentaryConfigurationSummaryRoot> getPACommentaryConfigurationsWithHttpInfo(String path) throws ApiException {
    ...
    GenericType<PACommentaryConfigurationSummaryRoot> localVarReturnType = new GenericType<PACommentaryConfigurationSummaryRoot>() {};

      Map<Integer, GenericType> returnTypeMap = new HashMap<Integer, GenericType>();
        returnTypeMap.put(200, new GenericType<PACommentaryConfigurationSummaryRoot>(){});
        returnTypeMap.put(400, new GenericType<ClientErrorResponse>(){});
	
      return apiClient.<PACommentaryConfigurationSummaryRoot>invokeAPIWithReturnMap("ConfigurationsApi.getPACommentaryConfigurations", localVarPath, "GET", localVarQueryParams, localVarPostBody,
