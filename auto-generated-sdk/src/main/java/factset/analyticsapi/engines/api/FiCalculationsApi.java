...
public class FiCalculationsApi {
 ...
 public FICalculationParametersRoot getCalculationParameters(String id) throws ApiException {
   ...
   */
 public StringRoot getCalculationResult(String id) throws ApiException {
   ...
   */
  public ApiResponse<StringRoot> getCalculationResultWithHttpInfo(String id) throws ApiException {
    Object localVarPostBody = null;
    ...
    GenericType<StringRoot> localVarReturnType = new GenericType<StringRoot>() {};
      ...
      return apiClient.<StringRoot>invokeAPIWithReturnMap("FiCalculationsApi.getCalculationResult", localVarPath, "GET", localVarQueryParams, localVarPostBody,
                               localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType,
                               localVarAuthNames, returnTypeMap, false);
  }
  /**
