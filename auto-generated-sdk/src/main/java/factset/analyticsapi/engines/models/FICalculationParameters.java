...
import factset.analyticsapi.engines.models.JobSettings;
import factset.analyticsapi.engines.models.Security;
...
public class FICalculationParameters implements Serializable {
  ...
  private java.util.List<Security> securities = new java.util.ArrayList<Security>();
  ...
  public FICalculationParameters securities(java.util.List<Security> securities) {
    
    this.securities = securities;
    return this;
  }

  public FICalculationParameters addSecuritiesItem(Security securitiesItem) {
  ...
  **/
  ...
  public java.util.List<Security> getSecurities() {
    return securities;
  }


  public void setSecurities(java.util.List<Security> securities) {
    this.securities = securities;
  }
  ...
  **/
  ...
  public FICalculationParameters jobSettings(JobSettings jobSettings) {
