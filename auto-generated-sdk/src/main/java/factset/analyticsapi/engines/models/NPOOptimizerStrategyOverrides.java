...
import factset.analyticsapi.engines.models.StringConstraintActionTuple;
...
public class NPOOptimizerStrategyOverrides implements Serializable {
  ...
  private java.util.List<StringConstraintActionTuple> constraints = null;
  ...
  **/
  ...
  public NPOOptimizerStrategyOverrides constraints(java.util.List<StringConstraintActionTuple> constraints) {
    this.constraints = constraints;
    return this;
  }

  public NPOOptimizerStrategyOverrides addConstraintsItem(StringConstraintActionTuple constraintsItem) {
    if (this.constraints == null) {
      this.constraints = new java.util.ArrayList<StringConstraintActionTuple>();
    }
  ...
  **/
  ...
  public java.util.List<StringConstraintActionTuple> getConstraints() {
    return constraints;
  }


  public void setConstraints(java.util.List<StringConstraintActionTuple> constraints) {
    this.constraints = constraints;
  }
