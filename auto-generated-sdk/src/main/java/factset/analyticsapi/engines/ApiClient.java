...
import factset.analyticsapi.engines.auth.Authentication;
import factset.analyticsapi.engines.auth.HttpBasicAuth;
...
public class ApiClient extends JavaTimeFormatter {
  ...
  public ApiClient(Map<String, Authentication> authMap) {
    ...
    setUserAgent("engines-api/5.6.0-rc.1/java");
    ...
    if (authMap != null) {
      auth = authMap.get("Bearer");
    }
    if (auth instanceof HttpBearerAuth) {
      authentications.put("Bearer", auth);
    } else {
