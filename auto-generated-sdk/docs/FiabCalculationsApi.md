...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            FIABCalculationStatus result = apiInstance.getCalculationById(id);
...
> java.util.Map&lt;String, FIABCalculationStatusSummary&gt; getCalculationStatusSummaries()
...
public class Example {
    public static void main(String[] args) {
        ...
        FiabCalculationsApi apiInstance = new FiabCalculationsApi(defaultClient);
        try {
            java.util.Map<String, FIABCalculationStatusSummary> result = apiInstance.getCalculationStatusSummaries();
            System.out.println(result);
        } catch (ApiException e) {
...
> runCalculation(fiABCalculationParameters)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            apiInstance.runCalculation(fiABCalculationParameters);
        } catch (ApiException e) {
