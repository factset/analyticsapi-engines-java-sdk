...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            apiInstance.cancelVaultCalculationById(id);
        } catch (ApiException e) {
            System.err.println("Exception when calling VaultCalculationsApi#cancelVaultCalculationById");
...
public class Example {
    public static void main(String[] args) {
        ...
        String id = "id_example"; // String | from url, provided from the location header in the Run Calculation endpoint
        try {
            Object result = apiInstance.getVaultCalculationById(id);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling VaultCalculationsApi#getVaultCalculationById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> Object runVaultCalculation(xFactsetContentOrganization, xFactsetContentType, vaultCalculationParameters)
...
public class Example {
    public static void main(String[] args) {
        ...
        VaultCalculationsApi apiInstance = new VaultCalculationsApi(defaultClient);
        String xFactsetContentOrganization = "xFactsetContentOrganization_example"; // String | For specifying the format of the calculation result. Accepted values are \"column\" or \"row\" or \"simplifiedrow\"
        String xFactsetContentType = "xFactsetContentType_example"; // String | For specifying the content type of the calculation result. Accepted values are either \"application/json\" or \"application/x-protobuf\"
        VaultCalculationParameters vaultCalculationParameters = new VaultCalculationParameters(); // VaultCalculationParameters | 
        try {
            Object result = apiInstance.runVaultCalculation(xFactsetContentOrganization, xFactsetContentType, vaultCalculationParameters);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling VaultCalculationsApi#runVaultCalculation");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
