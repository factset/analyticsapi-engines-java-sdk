...
This endpoint creates a template which is not linked to any specific PA3 tile. 
...
import factset.analyticsapi.engines.api.UnlinkedPaTemplatesApi;
...
This endpoint updates an existing unlinked PA template.
