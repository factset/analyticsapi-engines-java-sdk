...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            apiInstance.cancelPACalculationById(id);
        } catch (ApiException e) {
            System.err.println("Exception when calling PaCalculationsApi#cancelPACalculationById");
...
public class Example {
    public static void main(String[] args) {
        ...
        String id = "id_example"; // String | from url, provided from the location header in the Run Calculation endpoint
        try {
            Object result = apiInstance.getPACalculationById(id);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling PaCalculationsApi#getPACalculationById");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
...
> Object runPACalculation(xFactsetContentOrganization, xFactsetContentType, paCalculationParameters)
...
public class Example {
    public static void main(String[] args) {
        ...
        PACalculationParameters paCalculationParameters = new PACalculationParameters(); // PACalculationParameters | 
        try {
            Object result = apiInstance.runPACalculation(xFactsetContentOrganization, xFactsetContentType, paCalculationParameters);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling PaCalculationsApi#runPACalculation");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
