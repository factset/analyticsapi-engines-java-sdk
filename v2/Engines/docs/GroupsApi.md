...
> java.util.Map&lt;String, Group&gt; getPAGroups()
...
import factset.analyticsapi.engines.v2.api.GroupsApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            java.util.Map<String, Group> result = apiInstance.getPAGroups();
...
[**java.util.Map&lt;String, Group&gt;**](Group.md)
